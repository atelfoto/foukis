...
<div class="row">
	<?php foreach ($properties as $property): ?>
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" style="min-height:620px;">
			<div class="panel panel-default pan-property" style="position:relative;overflow:hidden;">
				...
				<span><?=  $this->Html->image(isset($property['Property']['thumb']) ? $property['Property']['thumb']: 'http://placehold.it/356x228',array("class"=>'img-responsive',"style"=>"height:228px")); ?></span>
	...
	<div class="paging text-center col-md-12" style ="">
		...
		<?php // $this->element("pagination-counter"); ?>
	</div>
</div>
