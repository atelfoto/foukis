<?= $this->Html->css(array(
	'//cdnjs.cloudflare.com/ajax/libs/fullcalendar/2.0.2/fullcalendar.css','//cdnjs.cloudflare.com/ajax/libs/fullcalendar/2.0.2/fullcalendar.print.css'),
	 array('inline'=>false)); ?>
<?php  echo $this->Html->script(array('//code.jquery.com/ui/1.11.1/jquery-ui.min.js',
...
<!-- Content Header (Page header) -->
				<!-- Main content -->
<?= $this->fetch('title'); ?><?php  echo $this->set('title_for_layout',__('Calendar') );  ?>
<?php $this->Html->addCrumb(__(' Calendar '), array('controller'=>'calendars','action'=>'index','escape' =>false)); ?>
