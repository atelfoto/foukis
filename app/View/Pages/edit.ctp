<?= $this->fetch('title'); ?><?php  echo $this->set('title_for_layout',__('Edit Page'));  ?>
<?php $this->Html->addCrumb(__(' pages'), array('controller'=>'pages','action'=>'adminindex','escape' =>false));
 	$this->Html->addCrumb(__('edit page')); ?>
<div class="row">
	<div class="col-md-10 col-md-offset-1 ">
		<div class="panel panel-primary ">
			<div class="panel-heading">
				<h1 class="panel-title"><?php echo __('edit Page'); ?></h1>
			</div>
			...
			<div class="form-group col-md-6">
				<div class="input-group ">
					<div class="input-group-addon"><?= _('Title') ?></div>
					<?php echo $this->Form->input('name', array('label'=>false,
					 'class' => 'form-control','placeholder'=>__('Name'))); ?>
					 <div class="input-group-addon"><?php // $lang ?></div>
				</div>
			</div>
			<div class="form-group col-md-6">
				<div class="input-group">
			...
			<?= $this->Form->input('content', array('label' => __("Content"),'class'=>'form-control','type'=>"textarea")); ?>
