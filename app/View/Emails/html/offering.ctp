				...
				<div class="content">
					<table>
						<tr>
							...
							<td align="right"><h6 class="collapse">Foukis Real Estate</h6></td>
						</tr>
					</table>
				</div>
			...
			<table>
				<tr>
					<td>
						...
						<p><b>Fax :</b> <?= nl2br(h($fax)) ; ?></p>
						<p><b>Email :</b> <?= nl2br(h($email)) ; ?> </p>
						<p><b>Genre :</b> <?= nl2br(h($gender)) ; ?> </p>
						<p><b>Propriété type :</b> <?= nl2br(h($property_id)) ; ?> </p>
						<p><b>Size :</b> <?= nl2br(h($size)) ; ?>&nbsp;m <sup>2</sup></p>
						<p><b>Year :</b> <?= nl2br(h($year)) ; ?> </p>
						<p><b>Price :</b> <?= nl2br(h($price)) ; ?>&nbsp;€</p>
						<p><b>Address :</b> <?= nl2br(h($address)) ; ?></p>
						<p><b>message</b></p>
						<!-- Callout Panel -->
						<p class="callout">
								<?= nl2br(h($message)); ?>

							<br /> <a href="#">Click it! &raquo;</a>
						</p><!-- /Callout Panel -->
									...
									<table align="left" class="column">
										<tr>
											<td>
												...
												<p class="">
													<a href="https://www.facebook.com/profile.php?id=100002851832503&fref=pb&hc_location=friends_tab" class="soc-btn fb">Facebook</a>
										...
										<tr>
											<td>
												...
												<p>Phone: <strong>408.341.0600</strong><br/>
													Email: <strong><a href="emailto:atelfoto@msn.com">atelfoto@msn.com</a></strong>
												</p>
											</td>
										</tr>
									</table><!-- /column 2 -->
