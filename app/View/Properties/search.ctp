	...
	<div class="col-md-12 block-wrapper">
		<?php if ($this->Session->read('Auth.User.id')): ?>
			...
			<div class="collapse" id="collapseExample">
				<div class="well">
					<?php echo  $this->Media->iframe('Property', $property['Property']['id']); ?>
				</div>
			</div>
		<?php endif; ?>
		<div class="pull-right">
			<?php echo $this->Html->link('<i class="glyphicon glyphicon-arrow-left"></i>','#', array('class' => 'btn btn-primary ', 'target' => '_blank','title'=>__('back'),'escape'=>false)); ?>
			</a>
		...
		<div id="slider" class="flexslider">
			<ul class="slides"> <!-- images -->
				...
				<li>
					...
					<?php echo $this->Html->image("/img/uploads/".$property['Property']['id']."/2014/12/".$property['Property']['id2']."-".$nbre."l.jpg",array("class"=>'img-responsive img-thumbnail')); ?>
				</li>
				<?php  }; ?>
			</ul>
		</div>
		<div id="carousel" class="flexslider">
			<ul class="slides">  <!-- thumbnails -->
				...
				<li>
					<?php echo  $this->Html->image("/img/uploads/".$property['Property']['id']."/2014/12/".$property['Property']['id2']."-".$nbre2."s.jpg",array("class"=>'img-responsive img-thumbnail')); ?>
				</li>
				<?php  }; ?>
			</ul>
		</div>
