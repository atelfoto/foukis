			...
			<table>
				...
				<tr>
					...
					<td>
						...
						<?php echo $this->Html->image('/media/img/align-center.png'); ?><label for="align-center-<?php echo $media['id']; ?>"><?= __d('media','Centre') ?></label>

						<input type="radio" name="align-<?php echo $media['id']; ?>" class="align" id="align-right-<?php echo $media['id']; ?>" value="right">
						<?php echo $this->Html->image('/media/img/align-right.png'); ?><label for="align-right-<?php echo $media['id']; ?>"><?= __d('media','Droite') ?></label>
					</td>
				</tr>
				<tr>
